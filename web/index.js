...
(function () {
  ...
  var L10N = {
    zh: {
      ...
      srcTemplate: "从模板", srcScript: "从脚本", btnEditScript: "编辑脚本", scrTitle: "查看/编辑脚本: ", scrEdit: "编辑", scrPreview: "预览", scrSave: "保存脚本",
      scrSaved: "脚本已保存", scrConflict: "文件已被外部修改,请刷新后重试", scrRevalidate: "脚本已修改,需重新校验(禁用→启用)后引擎才会接受。立即重新校验并启用?",
      scrRevalidateOk: "已重新校验并启用", scrLoadFail: "脚本加载失败: ", scrHint: "在独立编辑器中查看/修改脚本;保存后如内容有变更会引导重新校验。此处保存仅更新任务设置。",
      ...
      scrTitle: "查看/编辑脚本: ", scrEdit: "编辑", scrPreview: "预览", scrSave: "保存脚本",
      scrSaved: "脚本已保存", scrConflict: "文件已被外部修改,请刷新后重试", scrRevalidate: "脚本已修改,需重新校验(禁用→启用)后引擎才会接受。立即重新校验并启用?",
      scrRevalidateOk: "已重新校验并启用", scrLoadFail: "脚本加载失败: ",
      drawerTitle: "执行记录:", showAll: "显示全部(含 检查/冷却跳过)", noRuns: "暂无记录",
      saved: "已保存", validated: "校验通过", targetsFail: "投递目标加载失败: ",
      nameRequired: "请输入任务名称", pasteRequired: "请粘贴脚本内容",
    ...
    en: {
      ...
      srcTemplate: "From template", srcScript: "From script", btnEditScript: "Edit script", scrTitle: "View/edit script: ", scrEdit: "Edit", scrPreview: "Preview", scrSave: "Save script",
      ...
      scrRevalidateOk: "Re-validated and enabled", scrLoadFail: "Failed to load script: ", scrHint: "View/modify the script in a dedicated editor; saving a changed script walks you through re-validation. This form saves task settings only.",
